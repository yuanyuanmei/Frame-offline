...
package com.ljcx.framework.live.common;
...
import com.ljcx.framework.live.common.http.HttpConnection;
...
abstract public class AbstractClient {
    ...
    public AbstractClient(String endpoint, String version, Credential credential, String region,
        ...
        this.region = region;
        this.path = "/";
        this.sdkVersion = com.tencentcloudapi.common.AbstractClient.SDK_VERSION;
    ...
    public String call(String action, String jsonPayload) throws TencentCloudSDKException {
        ...
        if (resp.code() != com.tencentcloudapi.common.AbstractClient.HTTP_RSP_OK) {
    ...
    protected String internalRequest(AbstractModel request, String actionName) throws TencentCloudSDKException {
        ...
        if (okRsp.code() != com.tencentcloudapi.common.AbstractClient.HTTP_RSP_OK) {

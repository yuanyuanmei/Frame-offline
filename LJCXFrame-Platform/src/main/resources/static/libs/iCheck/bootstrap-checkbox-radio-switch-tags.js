!function ($) {
  ...
  * ======================== */
  ...
  $.fn.checkbox.defaults = {
    template: '<span class="icons"><span class="first-icon iconfont ico-squre"></span><span class="second-icon iconfont ico-squre-check"></span></span>'
  }
    ...
    var methods = {
      init: function () {
        return this.each(function () {
            ...
            $element.addClass('has-switch-tab');
            ...
            $element.find('label').on('mousedown touchstart', function (e) {
              ...
              if ($this.closest('.has-switch-tab').is('.deactivate'))
                $this.unbind('click');
              else {

...
package com.ljcx.generator.utils;

import com.ljcx.generator.entity.ColumnEntity;
import com.ljcx.generator.entity.TableEntity;
...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        String type=getConfig().getString("generate.type");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.ljcx" : mainPath;
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (StringUtils.isNotBlank(packageName)) {
            if("admin".equals(getConfig().getString("generate.type"))){
